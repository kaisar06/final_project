...
if __name__ == "__main__":
    ...
    parser.add_argument("--content_input", type=str, help="Content image(s) to stylize", default='shirt3.jpg')
    parser.add_argument("--batch_size", type=int, help="Batch size used only if you set content_input to a directory", default=5)
    parser.add_argument("--img_width", type=int, help="Resize content image to this width", default=1200)
    parser.add_argument("--model_name", type=str, help="Model binary to use for stylization", default='style_beauty_0.pth')
