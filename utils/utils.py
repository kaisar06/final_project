...
def load_checkpoint(filename="checkpoint.pth"):
    ...
    dir_contains_only_models.load_state_dict(checkpoint['model_state_dict'])
    optimize.load_state_dict(checkpoint['optimizer_state_dict'])
    epoch = checkpoint['epoch']
    loss = checkpoint['loss']
    return model, optimize, epoch, loss
...
def save_checkpoint(state, filename="checkpoint.pth"):
    ...
    Arguments:
    - state (dict): Contains model state, optimizer state, and additional training metadata.
